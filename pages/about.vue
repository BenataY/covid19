<template>
  <div class="About">
    ...
    <StaticCard>
      {{
        $t(
          '当サイトは新型コロナウイルス感染症 (COVID-19) に関する最新情報を提供するために、有志で開設したサイトです。'
        )
      }}<br />
      <br />
      {{
      ...
      {{
        $t(
          '正確な情報を迅速に提供する事を努めておりますが、利用者が当サイトの情報を用いて行う一切の行為について責任を負いかねます。'
        )
      }}
      <br />
      {{
      ...
      <br />
      <br />
      <a href="mailto:stopcovid19.ibaraki@gmail.com">メールからお問い合わせ</a>
    </StaticCard>
    <StaticCard>
      <h3>{{ $t('ブラウザ環境について') }}</h3>
      <p>
    ...
    <StaticCard>
      ...
      <p>
        {{
          $t(
            '当サイトに掲載されている情報の正確性については万全を期していますが、当サイトは利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。'
          )
        }}
      </p>
      <p>
